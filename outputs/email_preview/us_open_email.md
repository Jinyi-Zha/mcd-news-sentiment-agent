...
Subject: MCD Equities Briefing | US Open | 2026-09-02 18:14 London
Source briefing path: outputs/us_open_briefing.md

## Email Body

MCD Capital — Equities Briefing | US Open | 2026-09-02 18:14 BST
...
1. Theme: Tesla / FSD / deliveries / robotaxi
   ...
   Rep: Should Tesla Be Kicked Out Of Magnificent 7?
...
2. Theme: Apple / iPhone / App Store
   ...
   Rep: What's the Real Fuel for Apple Stock's Next Climb?
...
3. Theme: Microsoft / OpenAI / Azure
   ...
   Rep: Apple v. OpenAI: Governance Lessons in Trade Secret Protection from Both Sides of the “V”
...
4. Theme: Nvidia / AI chip / Blackwell / semiconductor
   ...
   Rep: Jim Cramer has a strong message for Nvidia stock investors
...
- Key tickers: watch follow-through in TSLA, GOOGL, AAPL.
