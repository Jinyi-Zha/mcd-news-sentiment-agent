...
Subject: MCD Equities Briefing | US Open | 2026-08-07 15:31 London
Source briefing path: outputs/us_open_briefing.md

## Email Body

MCD Capital — Equities Briefing | US Open | 2026-08-07 15:31 BST
...
1. Theme: Tesla / FSD / deliveries / robotaxi
   ...
   Rep: SpaceX’s Terafab will rely on natural gas power plants, not Tesla solar panels
...
2. Theme: Apple / iPhone / App Store
   ...
   Rep: Apple Stock Surged On An Upgrade Cycle Its Own Reports Flagged Early
   Relevance: iPhone and App Store coverage keeps consumer tech in focus.
3. Theme: Amazon / AWS
   Tickers: AMZN
   Evidence: 4 sources / 6 headlines
   Rep: Why Amazon, Alphabet and Uber Keep Showing Up in the Same Billionaire Portfolios
   Relevance: AWS headlines keep AI infrastructure spending in focus.
4. Theme: Nvidia / AI chip / Blackwell / semiconductor
   Tickers: NVDA
   Evidence: 4 sources / 6 headlines
   Rep: While everyone chases Nvidia, Caterpillar just showed where AI money goes next
